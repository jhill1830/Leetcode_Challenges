...
Then, the fleet (speed 2) and the car starting at 4 (speed 1) become one fleet, meeting each other at 6. The fleet moves at speed 1 until it reaches target.
        ...
        calculate time to destination(TTD) (target-position/speed).  If ith vehicle's TTD is less than another, it will become one fleet.  Will remove the one with the lower TTD
        """
...
print(test.carFleet(10, [6, 8], [3, 2]))
